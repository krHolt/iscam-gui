...
.doPlots <- function(png=TRUE){
  ...
  if(.checkEntries()){
    ...
    switch(pType,
           ...
           "sSelexLogisticAtAge"              = {plotSelex(1,png,"SelexLogisticAtAge",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sSelexLogisticAtLength"           = {plotSelex(2,png,"SelexLogisticAtLength",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sSelexLogisticAtAgeRelationship"        = {plotSelex(3,png,"SelexLogisticAtAgeRelationship",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sSelexLogisticAtLengthRelationship"     = {plotSelex(4,png,"SelexLogisticAtLengthRelationship",plotMCMC,ci,sensGroup=sgr,index=ind)},
